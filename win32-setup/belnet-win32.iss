...
#define MyAppName "Belnet"
#define MyAppVersion "0.7.0"
#define MyAppPublisher "Beldex Project"
#define MyAppURL "https://belnet.org"
#define MyAppExeName "belnetui.exe"
...
OutputBaseFilename=belnet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=0.7.0
VersionInfoCompany=Beldex Project
VersionInfoDescription=Belnet for Microsoft� Windows� NT�
#ifndef RELEASE
...
#endif
VersionInfoProductName=Belnet
VersionInfoProductVersion=0.7.0
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright �2018-2020 Beldex Project
AppMutex=belnet_win32_daemon,belnet_qt5_ui,belnet_dotnet_ui
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\belnet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libbelnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\belnet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libbelnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\belnet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libbelnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\belnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\belnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\belnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\belnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\belnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\belnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
...
Source: "{#DevPath}build\belnetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "belnet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "belnet-qt5-ui.7z"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall; MinVersion: 0,6.0;
Source: "belnet.ico"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "config_migration.bat"; DestDir: "{userappdata}\.belnet"; Flags: deleteafterinstall; MinVersion: 0,6.0
...
Type: filesandordirs; Name: "{app}\belnet-qt5-ui"; MinVersion: 0,6.0
Type: filesandordirs; Name: "{userappdata}\.belnet"
...
begin
  ...
  if IsTaskSelected('migrateconfigs') then
    MsgBox('Belnet JSON-RPC API endpoint enabled. Any custom configuration was retained in %APPDATA%\.belnet\belnet.old.ini.', mbInformation, MB_OK);
  end;
end;
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; OnlyBelowVersion: 0, 6.0; IconFilename: "{app}\belnet.ico"
Name: "{group}\{#MyAppName}"; Filename: "{app}\belnet-qt5-ui\belnetui.exe"; MinVersion: 0, 6.0; IconFilename: "{app}\belnet.ico"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppName}}"; Filename: "{#MyAppURL}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; OnlyBelowVersion: 0,6.0; IconFilename: "{app}\belnet.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\belnet-qt5-ui\belnetui.exe"; Tasks: desktopicon; MinVersion: 0,6.0; IconFilename: "{app}\belnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; OnlyBelowVersion: 0, 6.1; IconFilename: "{app}\belnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\{#MyAppName}"; Filename: "{app}\belnet-qt5-ui\belnetui.exe"; Tasks: quicklaunchicon; MinVersion: 0, 6.1; IconFilename: "{app}\belnet.ico"
...
Filename: "{app}\belnet-qt5-ui\belnetui.exe"; Flags: nowait postinstall skipifsilent; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; MinVersion: 0,6.0
...
Filename: "{tmp}\7z.exe"; Parameters: "x belnet-qt5-ui.7z -aoa"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated skipifdoesntexist; Description: "installing modern Qt5 UI"; StatusMsg: "Installing modern Qt5 UI..."; MinVersion: 0, 6.0;
Filename: "{app}\belnet-bootstrap.exe"; Parameters:"-L https://seed.belnet.org/belnet.signed --cacert rootcerts.pem -o ""{userappdata}\.belnet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
...
Filename: "{userappdata}\.belnet\config_migration.bat"; WorkingDir: "{userappdata}\.belnet"; Flags: runascurrentuser waituntilterminated; Description: "migrate existing config"; StatusMsg: "Migrating old configuration..."; MinVersion: 0,6.0; Tasks: migrateconfigs;